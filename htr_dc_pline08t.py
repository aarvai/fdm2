...
ylabel('instances')
xlabel('min')
title('5133 Line Heater On-Time Durations')
...
plot_cxctime(t_event, ylim(),'r:')
title('5133 Line Heater On-Time')
ylabel('min')
legend(loc=0)
...
ylim([0,30])
plot_cxctime(t_event, ylim(),'r:')
title('5133 Line Heater Duty Cycle')
ylabel('%')
legend(loc=0)
legend(loc=0)
...
plot_cxctime(t_event, ylim(),'r:')
title('5133 Line Heater Cycles Per Day')
legend(loc=0)
...
plot_cxctime(t_event, ylim(),'r:')
title('5133 Line Heater Accumulated On-Time Per Day')
ylabel('hrs')
legend(loc=0)
...
plot_cxctime(t_event, ylim(),'r:')
title('5133 Accumulated Line Heater Power on FDM-2 Per Day')
ylabel('W-hrs')
legend(loc=0)
